...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth, trim={5mm 5mm 5mm 5mm}, clip, page=1]{architecture/bdd_ibd}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth, trim={10mm 5mm 5mm 5mm}, clip, page=2]{architecture/bdd_ibd}
